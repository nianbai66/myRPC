...
extern PROTOBUF_INTERNAL_EXPORT_friend_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_FriendResultCode_friend_2eproto;
namespace RPC {
class FriendResultCodeDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<FriendResultCode> _instance;
...
static void InitDefaultsscc_info_FriendResultCode_friend_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::RPC::_FriendResultCode_default_instance_;
    new (ptr) ::RPC::FriendResultCode();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::RPC::FriendResultCode::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_FriendResultCode_friend_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_FriendResultCode_friend_2eproto}, {}};
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_GetFriendListResponse_friend_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_GetFriendListResponse_friend_2eproto}, {
      &scc_info_FriendResultCode_friend_2eproto.base,}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::RPC::FriendResultCode, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::RPC::FriendResultCode, errcode_),
  PROTOBUF_FIELD_OFFSET(::RPC::FriendResultCode, errmsg_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::RPC::FriendResultCode)},
  { 7, -1, sizeof(::RPC::GetFriendListRequest)},
  { 13, -1, sizeof(::RPC::GetFriendListResponse)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::RPC::_FriendResultCode_default_instance_),
...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014friend.proto\022\003RPC\"3\n\020FriendResultCode\022"
  "\017\n\007errcode\030\001 \001(\005\022\016\n\006errmsg\030\002 \001(\014\"&\n\024GetF"
  "riendListRequest\022\016\n\006userid\030\001 \001(\r\"O\n\025GetF"
  "riendListResponse\022%\n\006result\030\001 \001(\0132\025.RPC."
  "FriendResultCode\022\017\n\007friends\030\002 \003(\0142Z\n\020Fri"
  "endServiceRpc\022F\n\rGetFriendList\022\031.RPC.Get"
  "FriendListRequest\032\032.RPC.GetFriendListRes"
...
void FriendResultCode::InitAsDefaultInstance() {
}
...
FriendResultCode::FriendResultCode(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:RPC.FriendResultCode)
}
FriendResultCode::FriendResultCode(const FriendResultCode& from)
  ...
  // @@protoc_insertion_point(copy_constructor:RPC.FriendResultCode)
}

void FriendResultCode::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_FriendResultCode_friend_2eproto.base);
  errmsg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  errcode_ = 0;
}

FriendResultCode::~FriendResultCode() {
  // @@protoc_insertion_point(destructor:RPC.FriendResultCode)
  SharedDtor();
...
const FriendResultCode& FriendResultCode::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_FriendResultCode_friend_2eproto.base);
...
// @@protoc_insertion_point(message_clear_start:RPC.FriendResultCode)
...
::PROTOBUF_NAMESPACE_ID::uint8* FriendResultCode::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:RPC.FriendResultCode)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:RPC.FriendResultCode)
  return target;
}

size_t FriendResultCode::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:RPC.FriendResultCode)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:RPC.FriendResultCode)
  GOOGLE_DCHECK_NE(&from, this);
  const FriendResultCode* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<FriendResultCode>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:RPC.FriendResultCode)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:RPC.FriendResultCode)
    MergeFrom(*source);
  }
}

void FriendResultCode::MergeFrom(const FriendResultCode& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:RPC.FriendResultCode)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:RPC.FriendResultCode)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:RPC.FriendResultCode)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void GetFriendListResponse::InitAsDefaultInstance() {
  ::RPC::_GetFriendListResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::RPC::FriendResultCode*>(
      ::RPC::FriendResultCode::internal_default_instance());
}
class GetFriendListResponse::_Internal {
 public:
  static const ::RPC::FriendResultCode& result(const GetFriendListResponse* msg);
};

const ::RPC::FriendResultCode&
...
GetFriendListResponse::GetFriendListResponse(const GetFriendListResponse& from)
  ...
  if (from._internal_has_result()) {
    result_ = new ::RPC::FriendResultCode(*from.result_);
  } else {
    result_ = nullptr;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:RPC.GetFriendListResponse)
  ...
  if (from.has_result()) {
    _internal_mutable_result()->::RPC::FriendResultCode::MergeFrom(from._internal_result());
  }
}
...
template<> PROTOBUF_NOINLINE ::RPC::FriendResultCode* Arena::CreateMaybeMessage< ::RPC::FriendResultCode >(Arena* arena) {
  return Arena::CreateMessageInternal< ::RPC::FriendResultCode >(arena);
}
